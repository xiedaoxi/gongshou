    ...
    Paging.prototype = {
        ...
        createDom: function() {
            var that = this,
                ...
                wrapLength = 0;
            totalPages > 5 ? wrapLength = 10 * liWidth : wrapLength = totalPages * liWidth;
            ...
            content = '<p class="total-count">' +
                that.options.totalCount +
                '</p>'+'<button type="button" id="firstPage" class="turnPage first-page">首页</button>' +
                ...
                '<button type="button" id="lastPage" class="last-page">尾页</button><p class="total-pages">共&nbsp;' +
        ...
        bindEvents: function() {
            ...
            function handles(pageIndex) {
                ...
                if (pageIndex >= 5 && pageIndex <= totalPages - 5) distance = (pageIndex - 5) * liWidth;
                if (pageIndex >= 1 && pageIndex <= 5) distance = 0;
                // if (pageIndex == 2 || pageIndex == 1) distance = 0;
                if (pageIndex > totalPages - 5) distance = (totalPages - 10) * liWidth;
                pageSelect.css('marginLeft', '' + (-distance) + 'px');
